...
export function getCurrentQuarterInfo(cycle) {
  ...
  const windows = [
    { name: 'Q1', start: new Date(cycle.q1_start + 'T00:00:00'), end: new Date(cycle.q1_end + 'T23:59:59') },
    { name: 'Q2', start: new Date(cycle.q2_start + 'T00:00:00'), end: new Date(cycle.q2_end + 'T23:59:59') },
    { name: 'Q3', start: new Date(cycle.q3_start + 'T00:00:00'), end: new Date(cycle.q3_end + 'T23:59:59') },
    { name: 'Q4', start: new Date(cycle.q4_start + 'T00:00:00'), end: new Date(cycle.q4_end + 'T23:59:59') },
  ];
